			...
			<div class="home">
				<div class="content">
					<div class="featured">
						...
						<p>
							Như bạn đã biết âm nhạc như một phần của cuộc sống chúng ta, nó giúp chúng ta giải tỏa nỗi buồn , chia sẽ niềm vui . Chính vì thế Trung Tâm Âm Nhạc Thái Hưng như một sự lựa chọn đúng đắn.
						</p>
					</div>
					<div class="section">
						<h3>Chương Trình</h3>
				...
				<div class="sidebar">
					<ul>
						...
						<li>
							<span>10/2106</span>
							<h2>Đón chào thành viên mới thứ 1000</h2>
							<p>
								Vào ngày 20 - 10 - 2016, Trung Tâm đón chào thành viên mới thứ 1000 trong sự hân hoan của giáo viên và ban giam đốc <a href="userMusicSchool/blog.html" class="more">Xem Thêm</a>
							</p>
						</li>
						<li>
					...
					<a href="userMusicSchool/blog.html">Xem Thêm Bài Viết</a>
				</div>
			</div>
		</div>
		<div class="footer">
