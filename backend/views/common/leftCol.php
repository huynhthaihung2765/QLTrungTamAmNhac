      ...
      <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        <div class="menu_section active">
          ...
          <ul class="nav side-menu" style="">
            <li><a href="index.html"><i class="fa fa-home"></i> Trang chủ <span class="fa fa-chevron-down"></span></a>
            ...
            <li class=""><a><i class="fa fa-edit"></i> Quản lí học viên <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu" style="display: none;">
                <li class="current-page"><a href="xemhocvien.html">Xem học viên</a></li>
